...
# Find games that HAVE a contract_game_id and are not active/finished
$url = "https://arkckzzogbzvtflwdjoy.supabase.co/rest/v1/lobby_games?select=id,contract_game_id,wager_amount,status,created_at&contract_game_id=not.is.null&order=created_at.desc&limit=5"
try {
